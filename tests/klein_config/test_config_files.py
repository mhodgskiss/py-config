...
class TestConfigWithFiles():
    ...
    @mock.patch('argparse.ArgumentParser.parse_known_args',return_value=(argparse.Namespace(config="dummy.yml", common=None),argparse.Namespace()))
    ...
    @mock.patch('argparse.ArgumentParser.parse_known_args',return_value=(argparse.Namespace(config="dummy.json", common=None),argparse.Namespace()))
    ...
    @mock.patch('argparse.ArgumentParser.parse_known_args',return_value=(argparse.Namespace(config="dummy.conf", common=None),argparse.Namespace()))
    ...
    @mock.patch('argparse.ArgumentParser.parse_known_args',return_value=(argparse.Namespace(config="dummy.conf", common="dummy2.conf"),argparse.Namespace()))
    @mock.patch('codecs.open', new_callable=mock.mock_open, read_data=hoconString)
